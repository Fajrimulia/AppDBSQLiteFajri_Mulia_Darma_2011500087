package com.example.appdbsqlitefajri_mulia_darma
...
class MainActivity : AppCompatActivity() {
    private lateinit var adpMatkul: AdaptarMatakuliah
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adpMatkul = AdaptarMatakuliah(this@MainActivity, dataMatkul)
